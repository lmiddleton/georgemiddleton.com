...
<div id="nav">
	...
	<img src="assets/Divider.gif" alt="" class="divider" />
	<a href="illustrations.php" class='<?=($this->category == "illustrations") ? "active" : "";?>'>Illustration</a>
	<img src="assets/Divider.gif" alt="" class="divider" />
	<a href="about.php" class='<?=($this->category == "about") ? "active" : "";?>'>About</a>
	<img src="assets/Divider.gif" alt="" class="divider" />
	<a href="contact.php" class='<?=($this->category == "contact") ? "active" : "";?>'>Contact</a>
